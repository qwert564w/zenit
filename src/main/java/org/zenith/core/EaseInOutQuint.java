...
public class EaseInOutQuint extends EaseSineBase {
   public EaseInOutQuint(float var1, float var2) {
      super(var1, var2);
   }
   ...
   public float ease(float var1, float var2, float var3, float var4) {
      ...
      return -(f * (float)Math.pow(2.0, 10.0F * --var1) * (float)MathUtils.sin((var1 * var4 - f2) * (Math.PI * 2) / f1)) + var2;
   }
}
