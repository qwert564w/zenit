...
class GuiMultiBooleanSetting_RenderValue {
   public final GuiMultiBooleanSetting this_0;
   public final MultiSelectSetting.Option value;
   public final UiAnimation animationEnable;
   public CornerRadiusF bounds;

   public GuiMultiBooleanSetting_RenderValue(GuiMultiBooleanSetting var1, MultiSelectSetting.Option var2) {
      this.this_0 = var1;
      this.value = var2;
      this.animationEnable = new UiAnimation(200L, var2.isEnabled() ? 1.0F : 0.0F, Easing.CloseScreenEvent);
   }
   ...
   public void addRectToBatch(HudDrawContext var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      if (zenithstyle != null) {
         ...
         this.animationEnable.on23(this.value.isEnabled() ? 1.0F : (this.bounds.PotionItemBuilder(var2, var3) ? 0.5F : 0.0F));
